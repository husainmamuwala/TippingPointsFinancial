...
const Objective = () => {
  ...
  return (
    <div className=''>
        <div className='px-2'>
        <h4 className='text-3xl md:text-4xl font-garamond font-semibold py-2 tracking-wider'>Objective</h4>
            ...
            Obj.map((obj) => (
              <div className='flex flex-row'>
                ...
                <div className='self-center'>
                  <p className='text-xl lg:text-2xl italic self-center'>{obj.desc}</p>
                </div>
