...
const Cards = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between py-5 px-10'>
      <div className='self-center'>
        {
          Data.map((data) => (
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 w-1/2'>
              <div className='flex flex-row p-5 self-end'>
