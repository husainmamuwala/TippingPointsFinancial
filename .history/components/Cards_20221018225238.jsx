...
const Cards = () => {
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-center lg:space-x-10  px-10'>
      <div className='lg:px-10'>
        {
          Data.map((data) => (
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 '>
              <div className='flex flex-row p-5'>
                <div className='md:pr-10 pr-5 h-28 lg:h-44 self-center'>
                ...
                <div className='md:py-6 self-center'>
