    ...
    <div className='flex flex-col'>
        <div className='grid  justify-items-strech py-10'>
            ...
            <div className='justify-self-center'>
                <p className='font-Garamond md:text-5xl font-semibold pt-10 pb-10'>
                    <p className='text-center'>Investing in </p>
                    <p className='text-center'> the <span className='text-[#12445B]'>future !</span></p>
                    </p>
                </div>
        ...
        <div className='flex flex-row justify-evenly text-center text-md font-Montserrat md:text-2xl py-10'>
