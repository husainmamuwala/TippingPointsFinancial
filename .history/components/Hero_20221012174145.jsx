  ...
  return (
    <div className='flex flex-col'>
        <div className='grid  justify-items-strech py-10'>
            ...
            <svg className='scale-75 md:scale-100' width="128" height="90" viewBox="0 0 128 90" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className='flex flex-row justify-evenly text-center text-lg font-Montserrat md:text-2xl md:py-10 p-5'>
        <p className='text-center'>We do what we do.</p>
