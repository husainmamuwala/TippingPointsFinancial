        ...
        <div>
            <footer
                ...
                <div className="grid grid-flow-row w-full">
                    ...
                    <div className="justify-self-center items-center self-center flex flex-col md:flex-row">
                        <div className="w-28 md:w-48 items-center">
                        ...
                        <div className="text-center pl-5 md:text-left">
                            <h1 className="font-montserrat font-bold text-xl md:text-3xl">Vestidify Finance & Capital Pvt Ltd</h1>
                    
                            <h1 className="font-montserrat font-medium text-lg md:text-xl py-2">Investing in the Future</h1>
           
                            <a href="mailto:invest@vestify.com" 
                            className="font-montserrat font-normal text-lg md:text-xl">invest@vestidify.com</a>
                    
                            <div className="space-x-5 py-4">
                            {
                                Links.map((l)=>(
                                <Link href={l.Link} className="font-montserrat text-2xl">{l.name}</Link>
                                ))
                            }
                            </div>
                        </div>
                    ...
                    <a
                            ...
                            className="hover:text-[#7BE0B0] text-sm text-center pt-10"
                        >
