      ...
      <div className='lg:px-10'>
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 '>
              <div className='flex flex-row p-5'>
                <div className='pr-10 h-28 lg:h-44 self-start'>
                ...
                <div className='lg:py-6 self-center'>
                  ...
                  <div className='font-montserrat text-lg lg:text-3xl py-2 italic'>
                    <ol>
                        ...
                        <li>SL level always for Black Swan events and erratic market movements</li>
                        <li>Limited exposure to med-high risk trades (80:20 of the above 70%)</li>
                        <li>Algorithm-based insights to reduce exposure to high-risk trades</li>
                        <li>Fully hedged trades to reduce risk</li>
                    </ol>
                  </div>
                </div>
              </div>
