            ...
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 '>
              <div className='flex flex-row p-5'>
                ...
                <div className='lg:py-8 self-center'>
                  <h1 className='text-3xl lg:text-5xl font-semibold font-garamond'>Vested Risk Management Framework
</h1>
                  <p className='font-montserrat text-lg lg:text-3xl py-2 italic'>da</p>
                </div>
              </div>
            </div>
      </div>
