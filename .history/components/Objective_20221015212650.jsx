  ...
  return (
    <div className=''>
        ...
        <h4 className='text-3xl md:text-4xl font-garamond font-semibold py-2 tracking-wider'>Objective</h4>
         <svg className="lg:w-56 lg:w-56 lg:h-2" width="auto" height="2" viewBox="0 0 589 2" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            Obj.map((obj) => (
              <div className='flex flex-row'>
                ...
                <div className='self-center'>
                  <p className='text-xl lg:text-2xl italic'>{obj.desc}</p>
                </div>
