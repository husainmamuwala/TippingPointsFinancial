...
const Objectives = () => {
  const Data = [
    ...
    { title: "Mission", desc: "To become a flag bearer of the Derivatives market in India with the help of sophisticated technology" },
    { title: "Mission", desc: "To become a flag bearer of the Derivatives market in India with the help of sophisticated technology" },
  ]
  const Obj =[
  ...
  return (
    <div className='flex flex-col md:flex-row justify-between py-5 px-10'>
      <div className='basis-1/2'>
        {
          Data.map((data) => (
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 lg:w-6/5'>
      ...
      <div className='flex flex-col'>
        ...
        <div className='flex- flex-col'>
          ...
          <div className='flex flex-row mt-5'>
            <div className='pr-2 h-14 lg:h-auto'>
