                ...
                <div className="grid grid-flow-row w-full">
                    ...
                    <div className="justify-self-center items-center self-center text-center flex flex-col md:flex-row pt-4">
                        ...
                        <div className="text-center px-5 md:text-left">
                            ...
                            className="font-montserrat font-normal text-xl lg:text-xl underline hover:text-[#7BE0B0]">invest@vestidify.com</a>
                    
                            <div className="space-x-5 md:py-4 text-lg lg:text-xl hover:text-[#7BE0B0]">
                            {
                                Links.map((l)=>(
