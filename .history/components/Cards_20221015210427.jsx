...
const Cards = () => {
  ...
  return (
    <div className='grid grid-flow-row md:grid-flow-col justify-between py-5 px-10'>
      <div className='basis-1/2'>
        {
          Data.map((data) => (
            <div className=' bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-5 md:w-[50%]'>
              <div className='flex flex-row p-5 md:w-6/5'>
