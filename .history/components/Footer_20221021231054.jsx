            ...
            <footer
                ...
                <div className="grid grid-flow-row w-full">
                    ...
                    <div className="justify-self-center items-center self-center flex flex-col md:flex-row">
                        ...
                        <div className="text-left pl-5 space-y-28">
                            <span className="font-montserrat font-bold text-xl md:text-3xl">Vestidify Finance & Capital Pvt Ltd</span>
                            <br />
                            <span className="font-montserrat font-medium text-lg md:text-xl py-2">Investing in the Future</span>
                            <br />
