...
const Objectives = () => {
  const Data = [
    ...
    {title:"Mission",desc:"To grow investors wealth by bringing the brightest minds together and enable them to 
    function at optimal scale in the market"},
  ]
  return (
    <div className='flex flex-col md:flex-row justify-center py-5 px-10'>
        <div>
              {
                Data.map((data)=>(
           <div className='lg:w-4/5 bg-[#7BE0B0] bg-opacity-50 rounded-lg mb-4 lg:mb-0'>
