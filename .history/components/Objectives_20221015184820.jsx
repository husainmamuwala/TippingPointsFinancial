    ...
    <div className='flex flex-col md:flex-row justify-center py-5 px-10 md:px-0'>
        <div className=''>
          <div className='relative w-full bg-[#7BE0B0] bg-opacity-50 rounded-lg p-5 flex flex-row '>
              ...
              <div>
                <h1 className='text-3xl font-semibold font-garamond'>Vision</h1>
                <p className='font-montserrat text-xl'>To become the largest algo based hedge fund Globally </p>
              </div>
          </div>
