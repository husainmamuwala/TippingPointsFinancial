        ...
        <div>
            <footer
                ...
                <div className="grid grid-flow-row w-full">
                    ...
                    <div className="justify-self-center items-center self-center text-center flex flex-col md:flex-row">
                        ...
                        <div className="text-center pl-5 md:text-left">
                            <h1 className="font-montserrat font-bold text-2xl md:text-4xl">Vestidify Finance & Capital Pvt Ltd</h1>
                    
                            <h1 className="font-montserrat font-medium text-xl md:text-xl py-2">Investing in the Future</h1>
           
                            <a href="mailto:invest@vestify.com" 
                            className="font-montserrat font-normal text-xl md:text-xl">invest@vestidify.com</a>
                    
                            <div className="space-x-5 py-4 text-xl">
                            {
                                Links.map((l)=>(
