        ...
        <div>
            <footer
                ...
                <div className="grid grid-flow-row w-full">
                    ...
                    <div className="justify-self-center items-center flex flex-col md:flex-row">
                        ...
                        <div className="text-center">
                            ...
                            <br/>
                            <span className="font-montserrat font-semibold text-lg md:text-xl">Investing in the Future</span>
                            <br/>
                            <a href="mailto:invest@vestify.com" className="font-montserrat font-semibold text-lg md:text-xl>invest@vestidify.com</a>
                            <span ">invest@vestidify.com</span>
                            <br/>
