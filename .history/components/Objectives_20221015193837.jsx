  ...
  return (
    <div className='flex flex-col md:flex-row justify-between py-5 px-10'>
        <div>
          ...
          <div className='flex lg:flex-col pl-3'>
             <div>
                <h1 className='text-3xl lg:text-4xl font-semibold font-garamond'>
                  Objective
                </h1>
                <svg width="589" height="2" viewBox="0 0 589 2" fill="none" xmlns="http://www.w3.org/2000/svg">
             ...
             <div className='flex flex-row'>
                <div>
                  <svg width="24" height="97" viewBox="0 0 24 97" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <line x1="22.4654" y1="0.320545" x2="1.46535" y2="96.3205" stroke="#5FC4B3" stroke-width="3"/>
                  </svg>
                </div>
                <div>
                      <p>To Surpass the $10Bn boundary condition for a hedge fund</p>
                </div>
             </div>
          </div>
