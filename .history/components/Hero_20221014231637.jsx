    ...
    <div className='flex flex-col'>
      <div className='grid grid-flow-col py-10'>
        ...
        <div className='justify-self-center py-10'>
          <h4 className=' text-5xl text-center lg:text-8xl font-garamond pt-5 pb-5'>
            <span className="inline-block" >Investing in</span>
            <span> the <span className='text-[#12445B] font-semibold'>future !</span></span>
          </h4>
        </div>
