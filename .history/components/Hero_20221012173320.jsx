    ...
    <div className='flex flex-col'>
        <div className='grid  justify-items-strech py-10'>
            ...
            <div className='justify-self-center'>
                <p className=' text-5xl text-center md:text-8xl font-garamond pt-5 pb-5'>
                    <p>Investing in</p>
        ...
        <div className='flex flex-row justify-evenly text-center text-lg font-Montserrat md:text-2xl md:py-10'>
